...
Set-Content -Path (Join-Path $packageDir "README.txt") -Encoding UTF8 -Value @(
    ...
    "- Voice modes are separate: Fast, Local Streaming, and Online Streaming; preview.77 defaults to Online Streaming with NVIDIA Parakeet 1.1B RNNT multilingual and does not load local Qwen unless you switch modes",
