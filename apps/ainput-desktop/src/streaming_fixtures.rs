...
pub(crate) struct StreamingReplayPartialEntry {
    ...
    pub(crate) processing_elapsed_ms: u128,
    pub(crate) processing_realtime_factor: f64,
...
pub(crate) struct StreamingReplayReport {
    ...
    pub(crate) speech_start_ms: Option<u64>,
    pub(crate) first_partial_ms: Option<u64>,
    pub(crate) first_partial_after_speech_ms: Option<u64>,
    pub(crate) first_partial_processing_elapsed_ms: Option<u128>,
    pub(crate) first_partial_processing_lag_ms: Option<u128>,
    pub(crate) final_commit_ms: u64,
    pub(crate) processing_wall_elapsed_ms: u128,
    pub(crate) processing_realtime_factor: f64,
    pub(crate) final_decode_elapsed_ms: u128,
    pub(crate) online_final_elapsed_ms: u128,
    pub(crate) offline_final_elapsed_ms: u128,
    pub(crate) offline_final_timed_out: bool,
    pub(crate) punctuation_elapsed_ms: u128,
    pub(crate) rollback_count: usize,
    pub(crate) max_rollback_chars: usize,
    pub(crate) last_partial_content_chars: usize,
    pub(crate) final_extra_content_chars: usize,
    pub(crate) final_missing_content_chars: usize,
    pub(crate) last_partial_to_final_gap_ms: Option<u64>,
    ...
    pub(crate) final_offline_raw_text: String,
    pub(crate) final_prepared_candidate: String,
    pub(crate) hud_truth_text: String,
    pub(crate) pasted_text: String,
    pub(crate) hud_paste_equal: bool,
    pub(crate) offline_final_invoked: bool,
    pub(crate) ai_rewrite_mutation_count: usize,
    ...
    pub(crate) keyword_coverage: Option<f32>,
